...
<div class="header_user_info">
	<div data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cog"></i><span>{l s='Top links' mod='blockuserinfo'} </span></div>	
		<ul class="links">
		<li class="first">
			<a id="compare" href="{$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}" title="{l s='Product compare' mod='blockuserinfo'}"><i class="fa fa-exchange"></i>{l s='Product compare' mod='blockuserinfo'}</a>
		</li>
		{if $is_logged}
