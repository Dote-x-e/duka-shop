	...
	<div class="wishlist WhiteRounded">
		{foreach name=wl from=$wishlists item=wishlist}
			{if $smarty.foreach.wl.first}
				<a class="wishlist_button_list" data-link="{$product.id_product|intval}" tabindex="0" data-toggle="popover" data-trigger="focus" title="{l s='Wishlist' mod='blockwishlist'}" data-placement="right">
