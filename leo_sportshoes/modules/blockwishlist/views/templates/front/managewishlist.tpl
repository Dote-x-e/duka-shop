    ...
    {if !$refresh}
        ...
        <p class="submit">
            <div id="showSendWishlist">
                <a class="btn btn-outline button button-small" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
