...
{if $manufacturers}
 <div id="{$tab}" class="widget-manufacture">
	...
	<div class="block_content">
		<div class="carousel slide" id="manucarousel_{$tab}">
			{if count($manufacturers)>$itemsperpage}	 
				<a class="carousel-control left" href="#manucarousel_{$tab}" data-slide="prev"></a>
				<a class="carousel-control right" href="#manucarousel_{$tab}" data-slide="next"></a>
			{/if}
