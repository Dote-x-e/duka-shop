...
<div class="row">
    <div class="" id="slider">
            					...
            					{foreach $slides as $slide name=slides}
            						<div class="item {if $smarty.foreach.slides.first}active{/if} " data-slide-number="{$smarty.foreach.slides.index}">
            							{if  isset($slide[$t_image]) && $slide[$t_image]}
            								<img src="{$pathimg}{$slide[$t_image]}" alt="" style="" class="img-responsive">
            							{/if}	
            ...
            <ul class="list-inline control-slider">
              {foreach $slides as $slide name=item}
                <li> <a id="carousel-selector-{$smarty.foreach.item.index}" {if $smarty.foreach.item.first}class="selected"{/if}></a>
                </li>
              {/foreach}  
            </ul>
    </div>
